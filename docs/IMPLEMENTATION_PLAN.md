...
3. **Permissive third-party dependencies only.** MIT/Apache-2.0/BSD, pinned versions, and as few as possible (see [§5 Engineering decisions](#engineering-decisions)). The Autodesk API is referenced compile-time-only and never redistributed.
